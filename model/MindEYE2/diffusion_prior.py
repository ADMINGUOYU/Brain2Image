...
class BrainDiffusionPrior(DiffusionPrior):
    ...
    def load_mindeye2_weights(self, weight_path: str, map_location = None) -> None:
        ...
        print(f"\033[91mWARNING: You are using load_mindeye2_weights() in BrainDiffusionPrior which is designed to load pretrained weights from MedARC-AI/MindEyeV2. Make sure your weight file is compatible with this format.\033[0m")
        ...
        # We load all parameters started with "diffusion_prior."
        ...
        if items_needed != items_loaded:
            print(f"\033[93mLoaded {items_loaded}/{items_needed} parameters for MindEYE2 -> BrainDiffusionPrior. Please check the above messages for details.\033[0m")
        else:
            print(f"\033[92mSuccessfully loaded all {items_loaded} parameters for MindEYE2 -> BrainDiffusionPrior.\033[0m")
...
if __name__ == "__main__":
    ...
    diffusion_prior.load_mindeye2_weights(checkpoint_path, 'cpu')
